...
def test_version_constant() -> None:
    ...
    # that check (v0.1.7 is the tag of the release whose error messages quote
    # the provider's own refusal).  Bump this line with __version__.
    assert spacesage.__version__ == "0.1.7"
