...
def test_version_constant() -> None:
    ...
    # that check (v0.1.6 is the tag of the release whose exe first carries its
    # built-in rule packs).  Bump this line with __version__.
    assert spacesage.__version__ == "0.1.6"
