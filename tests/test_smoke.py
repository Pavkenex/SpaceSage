...
def test_version_constant() -> None:
    ...
    # that check (v0.1.4 is the tag of the release that first ships the settings
    # screen opening on a blank provider).  Bump this line with __version__.
    assert spacesage.__version__ == "0.1.4"
