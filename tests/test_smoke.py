...
def test_version_constant() -> None:
    ...
    # that check (v0.1.5 is the tag of the release that first ships WizTree 4.31
    # import support and the key field refusing a pasted key).  Bump this line
    # with __version__.
    assert spacesage.__version__ == "0.1.5"
